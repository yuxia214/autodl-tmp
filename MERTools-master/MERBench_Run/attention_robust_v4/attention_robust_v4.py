'''
AttentionRobustV4 - 基于P-RMF的概率化多模态融合模型 (结合ABAW8)
...
- ABAW8 Expression Recognition Challenge

使用方法:
1. 将此文件夹复制到服务器 MERBench 目录下
2. 运行 python setup_v4.py 自动安装到toolkit
...
class AttentionRobustV4(nn.Module):
    """
    AttentionRobustV4 - 概率化多模态情感识别模型 (结合ABAW8)
    ...
    def __init__(self, args):
        super(AttentionRobustV4, self).__init__()
