#!/bin/bash
# AttentionRobust V10 AV-only short run (non-debug)
...
LOG_FILE="${OUTPUT_DIR}/logs/train_v10_short_${TIMESTAMP}.log"

cd "${MERBENCH_ROOT}"

echo "=============================================="
echo "AttentionRobustV10 AV-only Short Training Start"
echo "Time: ${TIMESTAMP}"
echo "Log: ${LOG_FILE}"
echo "=============================================="
...
echo "=============================================="
echo "AttentionRobustV10 AV-only Short Training End"
echo "=============================================="
