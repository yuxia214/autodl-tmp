#!/bin/bash
# AttentionRobust V10 AV-only smoke run
...
LOG_FILE="${OUTPUT_DIR}/logs/train_v10_smoke_${TIMESTAMP}.log"

cd "${MERBENCH_ROOT}"

echo "=============================================="
echo "AttentionRobustV10 AV-only Smoke Start"
echo "Time: ${TIMESTAMP}"
echo "Log: ${LOG_FILE}"
echo "=============================================="
...
echo "=============================================="
echo "AttentionRobustV10 AV-only Smoke End"
echo "=============================================="
