...
############ For LINUX ##############
DATA_DIR = {
	'MER2023': '/root/autodl-tmp/MERTools-master/MERBench/dataset/mer2023-dataset-process',
    'IEMOCAPFour':  '/root/autodl-tmp/MERTools-master/MERBench/dataset/iemocap-process',
    'IEMOCAPSix':  '/root/autodl-tmp/MERTools-master/MERBench/dataset/iemocap-process',
    'CMUMOSI':  '/root/autodl-tmp/MERTools-master/MERBench/dataset/cmumosi-process',
    'CMUMOSEI': '/root/autodl-tmp/MERTools-master/MERBench/dataset/cmumosei-process',
    'SIMS': '/root/autodl-tmp/MERTools-master/MERBench/dataset/sims-process',
    'MELD': '/root/autodl-tmp/MERTools-master/MERBench/dataset/meld-process',
    'SIMSv2': '/root/autodl-tmp/MERTools-master/MERBench/dataset/simsv2-process',
}
PATH_TO_RAW_AUDIO = {
